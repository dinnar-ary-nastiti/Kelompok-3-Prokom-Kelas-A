...
def login_karyawan():
    ...
    bg_image = Image.open("bismillah/loginkaryawan.png")
...
def karyawan_absen(nama, nip):
    ...
    deadline = current_time.replace(hour=13, minute=0, second=0)
    ...
    bg_image = Image.open("bismillah/terimakasih.png")
    bg_photo = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(main_window, image=bg_photo)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_photo
...
def login_hrd():
    ...
    bg_image = Image.open("bismillah/loginhrd.png")
    bg_photo = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(main_window, image=bg_photo)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_photo
...
# Menambahkan latar belakang yang adjustable
    ...
    bg_image = Image.open("bismillah/hrddashboard.png")
    bg_photo = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(main_window, image=bg_photo)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_photo
...
def tampilkan_rekap_absensi():
    ...
    bg_image = Image.open("bismillah/rekapabsensi.png")
    bg_photo = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(main_window, image=bg_photo)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_photo
...
def tampilkan_rekap_gaji():
    ...
    bg_image = Image.open("bismillah/rekapgaji.png")
    bg_photo = ImageTk.PhotoImage(bg_image)
    bg_label = tk.Label(main_window, image=bg_photo)
    bg_label.place(relwidth=1, relheight=1)
    bg_label.image = bg_photo
...
def update_background(event):
    bg_image = Image.open("bismillah/selamatdatang.png")
